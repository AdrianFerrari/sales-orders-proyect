...
function Invoice({ data }) {
  return (
    <main className="flex flex-col min-w-full gap-2 bg-gray-50 p-3 border border-black">
      ...
      <section className="columns-2">
        ...
        <p>Time/Date:{data.time_order_taken}</p>
        <p>Sales Person:{data.sales_person_name}</p>
      </section>
